...
using Maruko.Events.Bus.Entities;
...
namespace Maruko.Event.Bus.Entities
{
    ...
    /// </summary>
    public class EntityChangeEventHelper : IDependencyTransient, IEntityChangeEventHelper
    {
        public IEventBus EventBus { get; set; }

        private readonly IUnitOfWork _unitOfWorkManager;

        public EntityChangeEventHelper(IUnitOfWork unitOfWorkManager)
        {
        ...
        public virtual void TriggerEvents(EntityChangeReport changeReport)
        {
            ...
            _unitOfWorkManager.SaveChanges();
        }
            ...
            foreach (var changedEntity in changedEntities)
            {
                switch (changedEntity.ChangeType)
                {
                    ...
                    case EntityChangeType.Deleted:
                        ...
                        break;
                    default:
                        throw new MarukoException("Unknown EntityChangeType: " + changedEntity.ChangeType);
                }
            }
        }
